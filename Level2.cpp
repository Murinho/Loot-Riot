...
bool Level2::init()
{
    ...
    if (gameAudioProfile == cocos2d::AudioEngine::INVALID_AUDIO_ID) {
        gameAudioProfile = cocos2d::AudioEngine::play2d("music/nebula_music.mp3", true, 1.0f);
    }
    ...
    auto grid = Sprite::create("nebula_grid.png");
...
void Level2::timerMethod(float dt) {
    tempo += dt;
    if (newheart) {
        heartGen();
    }
...
void Level2::boxBreaks(Point boxcoords) {
